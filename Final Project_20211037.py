...
def display_game_over():
    txt_game_over = game_font.render(game_result, True, BLUE)
...
pygame.display.set_caption("Final project_2021037")
...
# 벽 이미지 불러오기
wall = pygame.image.load(os.path.join(current_path, "wall.jpg"))

# 버블 이미지 불러오기
bubble_images = [
    pygame.image.load(os.path.join(current_path, "Red.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Yellow.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "White.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Orange.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Pink.png")).convert_alpha(),
    pygame.image.load(os.path.join(current_path, "Pyellow.png")).convert_alpha()
]
...
while play:
    ...
    text1 = font.render("FIRE COUNT:"+str(curr_fire_count), True, BLUE)
    screen.blit(background, (0, 0))
    screen.blit(wall, (0, wall_height - screen_height))
    pygame.draw.rect(screen,WHITE,[350,680,86,18],0)
    screen.blit(text1,(350,680))
    draw_bubbles()
